			...
			<div class="wrap">
					<div class="image-slider">
					    ...
					    <ul class="rslides" id="slider1">
					     <li><img src="http://images.mid-day.com/images/2015/aug/BEST-bus.jpg" alt=""></li>
					   
					      
					      <li><img src="http://images.mid-day.com/images/2014/mar/Shivajinagar-bus-depot.jpg"></li>
					    </ul>
						 <!-- Slideshow 2 -->
					</div>
					<!--End-image-slider---->
